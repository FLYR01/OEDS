...
output_file_path = "src/output/results_PCELL_23_labels.txt"  # Output file for detailed results
summary_file_path = "src/output/summary_PCELL_23_labels.txt"  # Output file for summary only
...
target_parent_cell_name = "PCELL_23"  # The parent cell you want to search under
