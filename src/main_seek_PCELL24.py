...
output_file_path = "src/output/results_PCELL_24.txt"  # Output file for detailed results
summary_file_path = "src/output/summary_PCELL_24.txt"  # Output file for summary only
